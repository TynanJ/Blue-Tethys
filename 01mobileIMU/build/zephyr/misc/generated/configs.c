...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_TASK_WDT_HW_FALLBACK_DELAY, 20);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_BUF_ACL_TX_SIZE, 511);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_BUF_ACL_RX_SIZE, 511);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_TASK_WDT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_TASK_WDT_CHANNELS, 5);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_TASK_WDT_HW_FALLBACK, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_TASK_WDT_MIN_TIMEOUT, 5000);
